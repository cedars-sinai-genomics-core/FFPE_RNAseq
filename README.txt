...
the results to the folder. Copy FFPE_mRNA_multiqc_report_generation.sh and 
FFPE_mRNA_count_matrix_generation.sh folder to the project folder (outside of results 
